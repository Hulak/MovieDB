...
public func registerProviderFactories() {
  ...
  __DependencyProviderRegistry.instance
    .registerDependencyProviderFactory(
      for: "^->RootDIComponent->AppDIComponent->AppCoordinatorDIComponent->MainFlowCoordinatorDIComponent->MainFlowInteractorDIComponent"
    ) { component in
      MainFlowInteractorDependencyc79c98b62a2c40ab1961Provider(component: component)
    }
  __DependencyProviderRegistry.instance
    .registerDependencyProviderFactory(
...
private class MainFlowInteractorDependencyc79c98b62a2c40ab1961BaseProvider: MainFlowInteractorDependency {
  init() {}
}

/// ^->RootDIComponent->AppDIComponent->AppCoordinatorDIComponent->MainFlowCoordinatorDIComponent->MainFlowInteractorDIComponent
private class MainFlowInteractorDependencyc79c98b62a2c40ab1961Provider: MainFlowInteractorDependencyc79c98b62a2c40ab1961BaseProvider {
  init(component: NeedleFoundation.Scope) {
    super.init()
  }
}
