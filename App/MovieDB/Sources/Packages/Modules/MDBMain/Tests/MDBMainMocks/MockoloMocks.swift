...
public class MoviesListInteractorDependencyMock: MoviesListInteractorDependency {
  public init() {}
  public init(networkingProvider: NetworkingProviderProtocol, saveImagesService: ImageSaveServiceProtocol, databaseService: DatabaseServiceProtocol) {
...
public class MovieDetailsInteractorDependencyMock: MovieDetailsInteractorDependency {
  public init() {}
  public init(networkingProvider: NetworkingProviderProtocol, saveImagesService: ImageSaveServiceProtocol) {
    _networkingProvider = networkingProvider
    _saveImagesService = saveImagesService
  }
...
public class MoviesListPresenterDependencyMock: MoviesListPresenterDependency {
  public init() {}
  public init(themeManager: ThemeManagerProtocol, localizer: LocalizerProtocol) {
